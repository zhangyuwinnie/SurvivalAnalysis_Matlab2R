function [xpart,ypart] = km2(time, censor, plotcens)
% Function km plots the kaplan meier curve 
% Given times, censor (0 = censored; 1 = uncensored), 
%       and an indicator of censor "plotcens"
...
plot(xpart,ypart,'--r','LineWidth',2);
hold on;
