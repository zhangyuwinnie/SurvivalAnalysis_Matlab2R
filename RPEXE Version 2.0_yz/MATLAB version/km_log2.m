function [xpart,ypart] = km_log2(time, censor, plotcens)
...
% If plotcens = 0 then no censoring if plotcens = 1 then censoring
...
logypart = log(ypart);
plot(xpart,logypart,'--r','LineWidth',2);
