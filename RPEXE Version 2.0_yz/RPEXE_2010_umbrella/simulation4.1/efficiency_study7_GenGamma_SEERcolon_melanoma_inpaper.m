...
reading = {'kme'; 'kme 10'; 'kme 30'; 'exponential';...
    'exp censored at 210';'exp q0.5';'gam';'wei';'logn';'pexe';...
    'umrpexe10';'umrpexe25';'umrpexe50';'umrpexe75';'umrpexe100';...
    'monorpexe10';'monorpexe25';'monorpexe50';'monorpexe75';...
    'monorpexe100';'monorpexe60';'umrpexe40';'berpexe10';...
    'berpexe25';'berpexe50';'berpexe75';'berpexe100'};
...
for i = 1:4,
    ...
    for j = 1:length(ts),
        res_gam(i,j).res       = gen_gam_test_inpaper2(beta,shape(i),...
            scale(i),Ns,ts(j),N);
...
res_gam_fourpanel2 = res_gam;
save res_gam_fourpanel2;


load res_gam_fourpanel2;
maxe = plotprederror1_inpaper2(res_gam_fourpanel2)
