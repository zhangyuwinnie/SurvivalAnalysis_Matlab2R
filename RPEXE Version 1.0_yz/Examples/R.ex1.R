...
setwd("/Users/zy/Desktop/SurvivalAnalysis/RPEXE Version 1.0 (03032014)/R version")

# include the R functions from the command line
source("../R version/RcodeREPEXEv1.r")

# load the data 
data_ex1 <- read.table("../Examples/data.ex1.txt", header=F)
oscensor <- data_ex1[,1]
ostime   <- data_ex1[,2]
